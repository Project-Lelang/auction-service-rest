...
type UserAddressCreateRequest struct {
	...
	Latitude       *float64 `json:"latitude"               validate:"omitempty,gte=-90,lte=90"    example:"-6.2000000"`
	Longitude      *float64 `json:"longitude"              validate:"omitempty,gte=-180,lte=180"  example:"106.8166667"`
